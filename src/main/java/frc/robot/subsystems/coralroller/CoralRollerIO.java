...
public interface CoralRollerIO {
    ...
    public static class CoralRollerIOInputs {
        ...
        public double targetPosition = 0.0; // Target position of the coralRoller
        ...
        public double position = 0.0; // Position of the coralRoller
        public double velocity = 0.0; // Velocity of the coralRoller
        public double coralRollerMotorStatorCurrent;
        public double coralRollerMotorPosition;
    }
