...
public class AlgaeRemoval extends Command {
  ...
  public AlgaeRemoval(Superstructure superstructure, int level) {
  ...
  public void initialize() {
    ...
    switch (m_level) {
      case 0:
        desiredElevatorPosition = ElevatorConstants.Setpoints.level3Pick;
        desiredCoralPivotPosition = CoralPivotConstants.Setpoints.level3Pick;        
        break;
      case 1:
        desiredElevatorPosition = ElevatorConstants.Setpoints.level2Pick;
        desiredCoralPivotPosition = CoralPivotConstants.Setpoints.level2Pick;        
        break;
