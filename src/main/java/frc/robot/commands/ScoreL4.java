...
public class ScoreL4 extends Command{
    ...
    public ScoreL4(CoralPivot coralPivot, Elevator elevator){
    ...
    @Override
    public void execute () {
        if (elevator.getPosition() > ElevatorConstants.Setpoints.scoreL4-elevatorThreshold && elevator.getPosition() < ElevatorConstants.Setpoints.scoreL4+elevatorThreshold);
